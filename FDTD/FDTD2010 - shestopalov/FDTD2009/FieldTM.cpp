...
void CFieldTM::WriteToBinEz(int timestp, int l, int d, int r, int u)
{
	string fileName;
	stringstream s;
	s << "K:\\Ez\\Ez[" << timestp << "].dat";
...
void CFieldTM::WriteToBinHx(int timestp, int l, int d, int r, int u)
{
	string fileName;
	stringstream s;
	s << "K:\\Ez\\Hx[" << timestp << "].dat";
	fileName = s.str();
	ofstream file(fileName.c_str(), ios::out | ios::binary);
	double tmp;
...
void CFieldTM::WriteToBinHy(int timestp, int l, int d, int r, int u)
{
	string fileName;
	stringstream s;
	s << "K:\\Ez\\Hy[" << timestp << "].dat";
	fileName = s.str();
	ofstream file(fileName.c_str(), ios::out | ios::binary);
	double tmp;
