...
void CFieldTE::WriteToBinHz(int timestp, int l, int d, int r, int u, string path)
{
	string fileName;
	stringstream s;
	s << path <<"\\Hz[" << timestp << "].dat";
	fileName = s.str();
...
void CFieldTE::WriteToBinEx(int timestp, int l, int d, int r, int u, string path)
{
	string fileName;
	stringstream s;
	s <<path <<"\\Ex[" << timestp << "].dat";
	fileName = s.str();
	ofstream file(fileName.c_str(), ios::out | ios::binary);
	double tmp;
...
void CFieldTE::WriteToBinEy(int timestp, int l, int d, int r, int u, string path)
{
	string fileName;
	stringstream s;
	s << path <<"\\Ey[" << timestp << "].dat";
	fileName = s.str();
	ofstream file(fileName.c_str(), ios::out | ios::binary);
	double tmp;
