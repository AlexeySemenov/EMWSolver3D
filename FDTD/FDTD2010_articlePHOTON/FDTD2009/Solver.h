...
//===================================================
	...
	void InitSimpleFDTD_TE_UPML (void);
	void SimpleFDTDSolver_TE_UPML(int timestep);
	void DeleteSimpleFDTD_TE_UPML (void);
	...
	void TimeStepLoopTE(int N, string path);
	void TimeStepLoopTM(int N);
