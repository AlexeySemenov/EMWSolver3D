...
void CFieldTE::WriteToBinHz(int timestp, int l, int d, int r, int u)
{
	string fileName;
	stringstream s;
	s << "K:\\Hz\\Hz[" << timestp << "].dat";
	fileName = s.str();
...
void CFieldTE::WriteToBinEx(int timestp, int l, int d, int r, int u)
{
	string fileName;
	stringstream s;
	s << "K:\\Hz\\Ex[" << timestp << "].dat";
	fileName = s.str();
	ofstream file(fileName.c_str(), ios::out | ios::binary);
	double tmp;
...
void CFieldTE::WriteToBinEy(int timestp, int l, int d, int r, int u)
{
	string fileName;
	stringstream s;
	s << "K:\\Hz\\Ey[" << timestp << "].dat";
	fileName = s.str();
	ofstream file(fileName.c_str(), ios::out | ios::binary);
	double tmp;
